    ...
    <section className="py-16 sm:py-20 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mx-auto max-w-2xl text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 lg:text-4xl mb-3 sm:mb-4">
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-3">
            {stats.map((stat, index) => (
              <div
                key={stat.label}
                className="group relative overflow-hidden rounded-xl sm:rounded-2xl bg-white p-6 sm:p-8 shadow-md border-2 border-gray-100 hover:border-[#02A1B2]/50 hover:shadow-xl transition-all duration-300"
                style={{
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="mb-4 sm:mb-6 inline-flex">
                    <div className="rounded-lg sm:rounded-xl bg-linear-to-br from-[#02A1B2] to-cyan-600 p-2 sm:p-3 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="mb-2 sm:mb-3">
                    <p className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 group-hover:text-[#02A1B2] transition-colors duration-300">
                      {stat.value}
                    </p>
                  </div>
